...
export const authRoutes = [
  ...
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/login-img/:layout`,
    Component: <LoginOne />,
  },
  {
  ...
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/login-validation/:layout`,
    Component: <LoginValidation />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/login-tooltip/:layout`,
    Component: <LoginTooltip />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/login-sweetalert/:layout`,
    Component: <LoginSweetalert />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/register-simple/:layout`,
    Component: <RegisterSimple />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/register-bg-img/:layout`,
    Component: <RegisterBgImg />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/register-video/:layout`,
    Component: <RegisterVideo />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/unlock-user/:layout`,
    Component: <UnlockUser />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/forget-pwd/:layout`,
    Component: <ForgetPwd />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/create-pwd/:layout`,
    Component: <CreatePwd />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/authentication/maintenance/:layout`,
    Component: <Maintenance />,
  },

  //Coming-soon
  {
    path: `${process.env.PUBLIC_URL}/pages/comingsoon/comingsoon/:layout`,
    Component: <ComingSimple />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/comingsoon/coming-bg-img/:layout`,
    Component: <ComingBgImg />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/comingsoon/coming-bg-video/:layout`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/pages/errors/error500/:layout`,
    Component: <Error500 />,
  },
  {
    path: `${process.env.PUBLIC_URL}/pages/errors/error503/:layout`,
    Component: <Error503 />,
  },
];
